...
class BusStopAdapter(private val onItemClicked : (Schedule) -> Unit) :
    ...
    class BusStopViewHolder(private val binding: BusStopItemBinding) :
        ...
        fun bind(schedule: Schedule) : Unit = binding.run {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BusStopViewHolder {
        val viewHolder  = BusStopItemBinding
            .inflate(LayoutInflater.from(parent.context), parent, false)
            .let { BusStopViewHolder(it) }
    ...
    override fun onBindViewHolder(holder: BusStopViewHolder, position: Int) : Unit =
