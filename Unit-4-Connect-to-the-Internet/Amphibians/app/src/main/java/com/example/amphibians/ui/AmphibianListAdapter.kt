 ...
 */
class AmphibianListAdapter(val clickListener: OnAmphibianClicked) :
    ListAdapter<Amphibian, AmphibianListAdapter.AmphibianViewHolder>(DiffCallback) {

    fun interface OnAmphibianClicked {
    ...
    class AmphibianViewHolder(
        ...
        fun bind(clickListener: OnAmphibianClicked, amphibian: Amphibian) {
